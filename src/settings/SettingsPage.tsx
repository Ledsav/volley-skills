  ...
  return (
    <div className="w-full bg-bg p-6 lg:p-8">
      ...
      <div className="mx-auto flex max-w-md flex-col gap-3">
        <section className="flex items-center justify-between rounded-lg border border-border bg-surface p-4 shadow-card">
          <div>
            <p className="font-medium text-ink">Appearance</p>
            <p className="text-sm text-slate">Switch between light and dark mode.</p>
          </div>
          <ThemeToggle className="flex shrink-0 items-center gap-2 rounded-md border border-border px-3 py-2 text-sm font-medium text-ink hover:bg-bg" />
        </section>
